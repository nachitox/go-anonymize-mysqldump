...
var (
	...
	usersQueryRecompiled     = "insert into wp_users values (1, 'josie_schoberg', 'NjaK5HeMAMuv', 'mona', 'teo.molzan@example.net', '', '2019-06-12 00:59:19', '', 0, 'Dilara Wilky'), (2, 'sinja', 'J3JRQ4XoIxXX6A', 'luka.rapp', 'abby.wachenbrunner@example.net', 'http://porth.com/greta', '2019-06-12 00:59:19', '', 0, 'Sascha von Lindner');\n"
